...
import { ArrowLeft, ChevronDown, ChevronUp, Clock, Star, CheckCircle2, Share2, FileText, Globe, Award, PlayCircle, Briefcase, Zap, Info, Loader2, Check } from "lucide-react";
...
export default function ProgramDetail({ item, onBack, onNavigate, brandName, accentColor }: ProgramDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 relative">
      ...
      <nav className="bg-white border-b border-slate-200 px-6 py-4 flex items-center gap-2 text-sm font-medium text-slate-500 shadow-sm sticky top-0 z-50">
        <button onClick={onBack} className="hover:text-black flex items-center"><ArrowLeft className="w-4 h-4 mr-1" /> Browse</button>
        <span>›</span>
      ...
      <div className="relative w-full overflow-hidden bg-[#f0f9ff] text-slate-900 min-h-[400px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 w-full grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <img src="https://images.pexels.com/photos/8278871/pexels-photo-8278871.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=40&w=40" className="w-8 h-8 rounded-full border border-slate-200" alt="Instructor" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-24">
                ...
                {openModule === i && (
                  <div className="p-6 sm:p-8 bg-white border-t border-slate-100 animate-fade-in flex flex-col md:flex-row gap-10">
                     ...
                     <div className="w-full md:w-5/12 aspect-[4/3] overflow-hidden rounded-2xl shadow-lg border border-slate-200 shrink-0 group">
                         <img src={mod.img} alt="Module Preview" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" />
                     </div>
                  </div>
                )}
              </div>
                ...
                {projectsList.map((proj: any, i: number) => (
                    <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-md border border-slate-200 group">
                        <div className="aspect-video overflow-hidden">
                            <img src={proj.img} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Project" />
                        </div>
                        <div className="p-8">
        ...
        <section id="Testimonials" className="bg-indigo-50/50 -mx-6 px-6 py-20 border-y border-slate-200">
        ...
        <section className="grid md:grid-cols-3 gap-6">
            <div className="bg-white border border-slate-200 p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center gap-5">
                    <img src="https://images.pexels.com/photos/8278871/pexels-photo-8278871.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=100&w=100" className="w-20 h-20 rounded-full object-cover border-4 border-slate-50" alt="Instructor" />
                    <div>
