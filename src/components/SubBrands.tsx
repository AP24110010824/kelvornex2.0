...
export default function SubBrands({ onOpenGadgets, onOpenSoftware, onOpenEducation, highlightEducation }: SubBrandsProps) {
            ...
            >
              {brands.map((b) => (
                <article
                  key={b.name}
                  onClick={() => {
                    if (b.id === "gadgets") onOpenGadgets?.();
                    if (b.id === "software") onOpenSoftware?.();
                    if (b.id === "education") onOpenEducation?.();
                  }}
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
