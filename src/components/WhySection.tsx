      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div>
          ...
          <p className="mt-4 text-sm md:text-base text-sage-500 leading-relaxed">
            From coding to design to marketing, we make learning skills easier,
            faster, and more practical with project-based courses and
            round-the-clock mentor support.
          </p>
