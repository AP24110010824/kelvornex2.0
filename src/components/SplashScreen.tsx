    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Orbit 2 – 45° */}
          <ellipse cx="50" cy="50" rx="42" ry="16"
            stroke="#000" strokeWidth="3.5" transform="rotate(45 50 50)"
            strokeDasharray="200"
            strokeDashoffset={phase >= 1 ? 0 : 200}
          ...
          {/* Orbit 3 – 90° */}
          <ellipse cx="50" cy="50" rx="42" ry="16"
            stroke="#000" strokeWidth="3.5" transform="rotate(90 50 50)"
            strokeDasharray="200"
            strokeDashoffset={phase >= 1 ? 0 : 200}
          ...
          {/* Orbit 4 – 135° */}
          <ellipse cx="50" cy="50" rx="42" ry="16"
            stroke="#000" strokeWidth="3.5" transform="rotate(135 50 50)"
            strokeDasharray="200"
            strokeDashoffset={phase >= 1 ? 0 : 200}
          ...
          <g style={{
            ...
            transition: "opacity 0.35s ease 0.4s, transform 0.5s cubic-bezier(0.34,1.56,0.64,1) 0.4s",
          }}>
            <path d="M50 72 L30.95 39 L69.05 39 Z" fill="#000000" />
            <path d="M50 28 L69.05 61 L30.95 61 Z"
              fill="none" stroke="#000000" strokeWidth="3.5" strokeLinejoin="round" />
          </g>

          {/* Electron dots */}
          <circle cx="20.3" cy="20.3" r="5.5" fill="#0900ff" style={{
            opacity: phase >= 1 ? 1 : 0,
            transform: phase >= 1 ? "scale(1)" : "scale(0)",
            transformOrigin: "20.3px 20.3px",
            transition: "opacity 0.3s 0.52s, transform 0.45s cubic-bezier(0.34,1.56,0.64,1) 0.52s",
          }}/>
          <circle cx="79.7" cy="20.3" r="5.5" fill="#008eff" style={{
            opacity: phase >= 1 ? 1 : 0,
            transform: phase >= 1 ? "scale(1)" : "scale(0)",
            transformOrigin: "79.7px 20.3px",
            transition: "opacity 0.3s 0.62s, transform 0.45s cubic-bezier(0.34,1.56,0.64,1) 0.62s",
          }}/>
          <circle cx="50" cy="92" r="5.5" fill="#00ccff" style={{
            opacity: phase >= 1 ? 1 : 0,
            transform: phase >= 1 ? "scale(1)" : "scale(0)",
            transformOrigin: "50px 92px",
            transition: "opacity 0.3s 0.72s, transform 0.45s cubic-bezier(0.34,1.56,0.64,1) 0.72s",
          }}/>
        </svg>
