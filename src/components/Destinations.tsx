...
export default function Destinations({ onCourseClick, onViewMoreClick }: DestinationsProps) {
  ...
  return (
    <section id="courses" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
      <div className="rounded-2xl sm:rounded-3xl bg-mint-100/60 border border-mint-200 p-4 sm:p-6 md:p-10">
